            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 font-bold pt-28 lg:pt-48 mb-10 lg:mb-20">
                <div className="w-full p-6 text-center lg:text-left flex align-middle ">
                    <section className='pt-10 lg:pt-20'>
                        <span className="text-5xl lg:text-6xl font-bold mb-1" style={{'color': '#373A85'}}>{title1}</span>
                        <div className="text-4xl lg:text-5xl font-bold mb-10" style={{'color': '#109EDA'}}>{title2}</div>
